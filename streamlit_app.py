...
if not daily_file or not employees_file:
    ...
    div[data-testid="stButton"] > button {
        ...
        border-radius: 30px !important; padding: 14px 48px !important;
    ...
    <div style="position:fixed;top:0;left:0;width:100vw;height:100vh;
        ...
        align-items:center;justify-content:center;gap:36px;z-index:1;">
        <img src="data:image/jpeg;base64,{_logo_b64}"
             style="max-width:80vw;max-height:72vh;object-fit:contain;" alt="iSchedule"/>
    </div>
    ''', unsafe_allow_html=True)
    ...
    with col2:
        ...
        if st.session_state.get("show_upload"):
            ...
            if daily_file and employees_file:
                st.session_state["daily_bytes"] = daily_file.read()
                st.session_state["daily_name"]  = daily_file.name
                st.session_state["emp_bytes"]   = employees_file.read()
                st.session_state["emp_name"]    = employees_file.name
                st.rerun()
