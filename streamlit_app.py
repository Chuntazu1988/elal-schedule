...
st.markdown("""
<div class="ops-rtl" style="background:#f8fbff;border:1px solid #d9e2ef;border-radius:14px;padding:10px 12px;margin-bottom:14px;">
<b>מקרא צבעים:</b>
<span style="color:#5e168a;font-weight:900;">סגול = ראש צוות</span> |
<span style="color:#a30d19;font-weight:900;">אדום = מפקח TSA</span> |
<span style="color:#106b2f;font-weight:900;">ירוק = שומר TSA</span> |
<span style="color:#1f2933;font-weight:900;">כחול/לבן = דיילת</span> |
<span style="color:#8a4b00;font-weight:900;">כתום = מתאם/טרייני</span>
</div>
""", unsafe_allow_html=True)
