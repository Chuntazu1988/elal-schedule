...
if not daily_file or not employees_file:
    ...
    /* Dark background matching the landing hero */
    .stApp, [data-testid="stAppViewContainer"] {
        background: linear-gradient(145deg,#050d1a 0%,#0a1a35 55%,#071430 100%) !important;
    }

    /* Let's Fly button */
    div[data-testid="stButton"] > button {
        background: linear-gradient(120deg,#1a6bff 0%,#00d4ff 100%) !important;
        color: #fff !important;
        ...
        box-shadow: 0 8px 32px rgba(26,107,255,.45) !important;
        letter-spacing: .5px !important;
        transition: all .2s ease !important;
    }
    div[data-testid="stButton"] > button:hover {
        box-shadow: 0 12px 40px rgba(26,107,255,.65) !important;
    }

    /* File uploaders — dark glassmorphism */
