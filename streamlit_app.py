...
def employee_shift_text(employees_df, emp_name):
    """Return exact shift hours from employee file only."""
...
def build_next_task_labels(result_df, employees_df):
    ...
    break_used = {}
    HELP_THRESHOLD_MINUTES = 240  # Very high. Use help only in extreme gaps.
    ...
    for idx, row in timed_df.sort_values("_start_dt").iterrows():
        ...
        # For 65-minute requirement, show רענון wording when it fits better.
